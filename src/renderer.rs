...
impl BaseRendererState {
    ...
    pub fn make_pbr_textures_bind_group(
        ...
        //     [255, 127, 0, 255]
        // };
        // let default_emissiveness = if use_gltf_defaults {
        //     [255, 255, 255, 255]
        // } else {
        //     [0, 0, 0, 255]
        // };
        // let defualt_ambient_occlusion = [255, 255, 255, 255];
...
impl RendererState {
    ...
    pub fn update(&mut self, game_state: &mut GameState, logger: &mut Logger) {
        ...
        //                 offset: 0,
        //                 size: NonZeroU64::new(
        //                     self.bones_buffer.capacity_bytes().try_into().unwrap(),
        //                 ),
        //             }),
        //         }],
        //         label: Some("bones_bind_group"),
        ...
        //     );
        //     if resized {
        //         // if previous_buffer_capacity_bytes > geometry_buffers.instance_buffer.capacity_bytes() {
        //         logger.log(&format!(
        ...
        // dbg!(
        //     self.instances_buffer.length(),
        //     self.instances_buffer._capacity(),
        // );
    ...
    fn render_pbr_meshes<'a>(
        ...
        });
        {
            ...
            for pbr_instance_slice in &self.all_pbr_instances.instances {
                ...
                // render_pass.set_vertex_buffer(1, geometry_buffers.instance_buffer.src().slice(..));
                render_pass.set_index_buffer(
